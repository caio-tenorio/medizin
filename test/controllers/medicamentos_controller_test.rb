...
class MedicamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicamento" do
    assert_difference('Medicamento.count') do
      post medicamentos_url, params: { medicamento: { nome: @medicamento.nome, preco_final: @medicamento.preco_final, preco_inicial: @medicamento.preco_inicial, validade: @medicamento.validade } }
    end
  ...
  test "should update medicamento" do
    patch medicamento_url(@medicamento), params: { medicamento: { nome: @medicamento.nome, preco_final: @medicamento.preco_final, preco_inicial: @medicamento.preco_inicial, validade: @medicamento.validade } }
